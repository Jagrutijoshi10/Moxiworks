...
self.getrecords = (req, res) => {
    ...
    con.query("SELECT * FROM agent where agent_id_from_url=? and time_log=?",[moxiWorksAgentId,created], function (err, result, fields) {
        if (err) throw err;
